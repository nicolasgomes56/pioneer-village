declare namespace SocketServer {
	...
	interface ServerEvents {
		...
		["character-get.food-drink"]: (
			charId: number,
			cb: (food: number, drink: number) => void,
		) => void;
		["character-get.health-metadata"]: (
			charId: number,
			cb: (metadata: CharacterHealthMetadata) => void,
		) => void;
		["character-get.currencies"]: (
			serverId: number,
			cb: (currencies: CharacterCurrencies) => void,
		) => void;
	}
